...
import { APP_NAME, COPY_RIGHT } from '@/constants/app.constant'
            ...
            >
                ...
                <div>
                    <h3 className="text-white mb-4">
                        Jump start your project with Reportsatwork
                    </h3>
                    <p className="text-lg text-white opacity-80 max-w-[700px]">
                        Reportsatwork comes with a complete set of UI components
